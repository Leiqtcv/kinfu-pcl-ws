...
*/
  ...
  publishPose (KinfuTracker& kinfu, const sensor_msgs::ImageConstPtr& depth)
  {
    ...
    tf::StampedTransform tempTrans = tf::StampedTransform(transform, depth->header.stamp, odom_frame_id, child_frame_id);
    nav_msgs::Odometry odom;
    odom.header.stamp = depth->header.stamp;
    odom.header.frame_id = odom_frame_id;
    odom.child_frame_id = child_frame_id;
    tf::poseTFToMsg(transform, odom.pose.pose);

    // robot_pose_ekf doesn't accept all-zeros in the covariance matrix
    odom.pose.covariance = boost::assign::list_of(visualCovariance)(0)(0)(0)(0)(0)
                                                   (0)(visualCovariance)(0)(0)(0)(0)
                                                   (0)(0)(999999)(0)(0)(0)
                                                   (0)(0)(0)(999999)(0)(0)
                                                   (0)(0)(0)(0)(999999)(0)
                                                   (0)(0)(0)(0)(0)(visualCovariance);
    odom.twist.covariance = boost::assign::list_of(visualCovariance)(0)(0)(0)(0)(0)
                                                   (0)(visualCovariance)(0)(0)(0)(0)
                                                   (0)(0)(999999)(0)(0)(0)
                                                   (0)(0)(0)(999999)(0)(0)
                                                   (0)(0)(0)(0)(999999)(0)
    ...
    if(publishTF){
        odom_broad.sendTransform(tempTrans);
    }
  }
  ...
  void initPublishers()
  {
    ...
    odom_pub = nh.advertise<nav_msgs::Odometry>("/vo", 10);
    nh.param<std::string>("kinfuLS/child_frame_id", child_frame_id, "/kinfu_frame");
    nh.param<std::string>("kinfuLS/odom_frame_id", odom_frame_id, "/odom");
    nh.param<double>("kinfuLS/visual_covariance", visualCovariance, 0.2);
    nh.param<bool>("kinfuLS/publish_tf", publishTF, true);
  }
